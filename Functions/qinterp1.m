...
% This function uses linear interpolation method for interpolation.
...
% Website: https://github.com/Zuan-Khalik/TOOFAB
...
% qinterp1 provides a speedup over interp1 but requires an evenly spaced x array.
% As x and y increase in length, the run-time for interp1 increases linearly,
% but the run-time for qinterp1 stays constant.
% For small-length x, y, and xi, qinterp1 runs about 6x faster than interp1.

%% Script description
% Script used to obtain time-frequency domain datas shown in Figures 21-22 in Ref. [1].
% It should be noted that this program takes about 6h, so please wait patiently.
